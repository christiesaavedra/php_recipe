...
angular.module('sproutApp.controllers', [])
    ...
    .controller('NewUserController', function ($scope, SessionService, Restangular) {
          Restangular.all('create-user').customPOST($scope.user = {}).then(function () {
                $scope.status = "New user was successfully created!";
                $scope.recipe = { ingredients: [], tags: [] };
            }, function () {
                $scope.status = "New user was NOT created";
            });
    })
